...
SIM.action.mapActions['DRcalo'] = 'DRcaloSiPMSDAction'
...
SIM.action.trackerSDTypes = [u'tracker']
...
SIM.filter.filters = {u'edep0': {'parameter': {u'Cut': 0.0}, 'name': u'EnergyDepositMinimumCut/Cut0'}, u'geantino': {'parameter': {}, 'name': u'GeantinoRejectFilter/GeantinoRejector'}, u'edep1kev': {'parameter': {u'Cut': 0.001}, 'name': u'EnergyDepositMinimumCut'}}
...
SIM.part.saveProcesses = [u'Decay']
...
##     
SIM.physics.rejectPDGs = set([1, 2, 3, 4, 5, 6, 21, 23, 24, 25])
...
##     
SIM.physics.zeroTimePDGs = set([17, 11, 13, 15])
