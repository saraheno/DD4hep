...
static Ref_t create_detector(Detector& description, xml_h e, SensitiveDetector sens)  {
  ...
  std::cout<<"Creating Crystal Ecal"<<std::endl;
  ...
  std::cout<<"exiting Crystal Barrel creator"<<std::endl;

  return sdet;
}

DECLARE_DETELEMENT(DD4hep_CrystalEcalBarrel,create_detector)
DECLARE_DEPRECATED_DETELEMENT(CrystalEcalBarrel,create_detector)
